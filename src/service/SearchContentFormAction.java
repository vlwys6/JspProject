...
public class SearchContentFormAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			SearchBoardDao pbd = SearchBoardDao.getInstance();
			//조회수 올리기
			pbd.view(bd_num); //리턴값이 없으니 void로 작성
		...
		return "searchboard/searchContent.jsp";
	}
