...
public class SearchCommDeleteProAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Search CommDeleteProAction Exception->"+e.getMessage());
	}
		return "searchboard/searchCommDeletePro.jsp";
	}
