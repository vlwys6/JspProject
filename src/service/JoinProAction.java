...
public class JoinProAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			userinfo.setId(multi.getParameter("id"));
			userinfo.setPw(multi.getParameter("pw"));
			userinfo.setName(multi.getParameter("name"));
			userinfo.setNick(multi.getParameter("nick"));
			userinfo.setGender(multi.getParameter("gender"));
			userinfo.setEmail(multi.getParameter("email"));
			userinfo.setUserpic("img\\"+filename);
			
			UserInfoDao ui = UserInfoDao.getInstance();//DB 
	       result = ui.insert(userinfo);
