...
<form action="tipDeletePro.do?pageNum=${pageNum }&bd_num=${bd_num}" method="post" enctype="multipart/form-data">
...
<div class="out" style="padding-bottom:144px;">
	...
	<div style="font-size:18px; margin:10px;">게시글을 삭제하시겠습니까?</div>


	<div>
		<input class="bt" type="submit" value="예">
