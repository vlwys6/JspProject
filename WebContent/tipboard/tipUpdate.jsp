...
<nav id="menu">
   ...
   <ul >
     ...
     <p><p><p> </div>
<div style="padding-bottom:100px; text-align:center; padding-bottom: 100px;">
   

   <div style="font-size:1.0em; width:100%; margin-top:50px;">팁&노하우</div>
   <div style="font-size:2.0em; width:100%; font-weight:bold; margin-bottom:20px;">글수정</div>

<form action="tipUpdatePro.do?bd_num=${bd_num }&pageNum=${pageNum }&id=${id}&type_num=200" method="post" enctype="multipart/form-data">
   ...
   <table>
      <tr>
         <td><input type="text" name="bd_title" required="required" placeholder="제목을 입력하세요" value="${board.bd_title}" style="width:1000px; height:40px; vertical-align:middle; border: 1px solid #E4E4E4; border-radius:5px;"></td>
      </tr>
      <tr></tr><tr></tr><tr></tr>
      <tr>
         <td>
         <label class="input-file-button" for="pic"> + 파일추가</label>
         <input type="file" name="bd_pic" id="pic"></td>
      </tr>
      <tr>
         <td><textarea rows="20" cols="137" name="bd_cont" required="required" placeholder="내용을 입력하세요" style="border: 1px solid #E4E4E4; border-radius:5px;">${board.bd_cont}</textarea></td>
      </tr>
      <tr>
         <td colspan="2"><input class="bt" type="button" value="취소" onclick="history.back()" style="background-color:white; color:#2E8B57;">&nbsp;&nbsp;
         <input class="bt" type="submit" value="글쓰기" style="background-color:#2E8B57; color:white;"></td>
      </tr>
   </table>
</form>
</div><p>
