...
<div style="padding-bottom:100px; text-align:center;">
	...
	<div style="font-size:2.0em; width:100%; font-weight:bold; margin-bottom:20px;">글쓰기</div>
...
<form action="tipWritePro.do?bd_num=${bd_num }&pageNum=${pageNum }&id=${id}&type_num=200" method="post" enctype="multipart/form-data">
	...
	<table>
		<tr>
			<td><input type="text" name="bd_title" required="required" placeholder="제목을 입력하세요" style="width:1000px; height:40px; vertical-align:middle; border: 1px solid #E4E4E4; border-radius:5px;"></td>
		</tr>
		<tr></tr><tr></tr><tr></tr>
		<tr>
			<td>
		...
		<tr>
			<td><textarea rows="20" cols="137" name="bd_cont" required="required" placeholder="내용을 입력하세요" style="border: 1px solid #E4E4E4; border-radius:5px;"></textarea></td>
		</tr>
		<tr>
