...
<div style="width: 100%; padding-bottom:160px; text-align: center;">
	<div style="font-size:1.0em; width:100%; margin-top:115px;">반려동물자랑</div>
	<div style="font-size:2.0em; width:100%; font-weight:bold; margin-bottom:40px;">댓글수정</div>
	

<form action="petCommUpdatePro.do?bd_num=${bd_num}&pageNum=${pageNum}">
	<input type="hidden" name="type_num" value="100">
