...
<div class="out" style="padding-bottom:144px;">
	...
	<div>
		<input class="bt" type="button" value="예" onclick="location.href='petCommDeletePro.do?pageNum=${pageNum}&bd_num=${bd_num }&board_id=${board_id }&comm_num=${comm_num }&id=${id }&commPageNum=${commPageNum }&type_num=${type_num}'">
