...
<nav id="menu">
    ...
    <div class="container">
        ...
        <hr /><br />
        <form action="myInfoUpdatePro.do" method="post"  name="frm"  enctype="multipart/form-data" onsubmit="return chk()"  >
        
            <input type="text" placeholder=" &nbsp;${userInfo.id }" value="${userInfo.id }" readonly="readonly" name="id" required style="height:30px; width: 495px"  ><br/><br />
    
            <input type="password" placeholder=" &nbsp;${userInfo.pw }" name="pw" required style="height:30px; width: 495px" /><br /><br />
           
            <input type="text" placeholder=" &nbsp;${userInfo.name }" name="name" required style="height:30px; width: 495px" /><br /><br />
  
            <input type="email" placeholder=" &nbsp;${userInfo.email }" name="email" required style="height:30px; width: 495px" /><br />
            <p>
               <h2>프로필사진 : </h2><img src="${context }/${userInfo.userpic}" width="200" height="200" > <br /><br />
            
            프로필 변경 : <input type="file"  name="userpic"  required="required"/><br />
            
            
            <p>
      
       
            <input type="submit" value="수정"     id="signup1" /><br /><br />
