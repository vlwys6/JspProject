	...
	<ul >
     ...
     <p><p><p>
      ...
      <div style=" text-align: center; margin-top:50px; padding-bottom:100px;">
	     <form action="storeUpdatePro.do" method="post" enctype="multipart/form-data">
              ...
              <table>
				<tr><td style="font-size:17px;">수정하기</td></tr>
				<tr><td style="font-size:38px; font-weight:bold;">스토어제품</td></tr>
				<tr><td><input type="text" name="bd_title" placeholder="수정할 제목을 입력하세요" required="required" style="height:40px; vertical-align:middle; border: 1px solid #E4E4E4; border-radius:5px;"></td></tr>
				<tr></tr><tr></tr><tr></tr>
				...
				<tr><td><pre><textarea rows="20" cols="137" name="bd_cont" placeholder="수정할 내용을 입력하세요" required="required" style="border: 1px solid #E4E4E4; border-radius:5px;"></textarea></pre></td></tr>
				
				<tr><td><input type="text" name="s_cnt" placeholder="수정할 제품 수량을 정해주세요." required="required" style="height:40px; vertical-align:middle; border: 1px solid #E4E4E4; border-radius:5px;"></td></tr>
				
				<tr><td><input type="text" name="s_price" placeholder="수정할 제품 가격을 정해주세요" required="required" style="height:40px; vertical-align:middle; border: 1px solid #E4E4E4; border-radius:5px;"></td></tr>
